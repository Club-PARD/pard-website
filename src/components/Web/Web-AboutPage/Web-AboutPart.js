    ...
    const [part, setPart] = useState([
              ...
              },
      {
        ...
        <>UX/UI 디자인 이론을 배우며, 사용자 중심 사고를 기르고
         ...
         <br /><br />현업 실무자 분들, 그리고 타 파트과의 협업을 통해 디자인 뿐 아니라
         <br />기획, 사용자 조사, 데이터 도출, 개발자와 협업 등 비즈니스에 대한
         <br />이해와 전문성을 갖추어 협업에 최적화 된 디자이너로 성장합니다.</>,
      ...
      },
      {
        ...
        <><br />웹과 서비스 개발을 위한 이론을 배우고 실습/협업 합니다.
         ...
         <br />React 프레임워크 기반으로 웹 서비스를 개발 할 뿐 아니라
      ...
      },
      {
        ...
        <br />전반적인 시스템 인프라를 구축 및 배포 및 운영 합니다. 자바의
