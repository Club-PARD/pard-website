...
const news = [
  ...
  },
  {
    ...
    description:
      "이브(EVE)팀은 장애인의 관광 접근성 불등을 해소하기 위한 무장애 여행 정보 웹서비스(무블)로\n대상을 수상했다. '무블'은 장애인들이 여행지의 접근성 정보를 쉽게 얻을 수 있도록 도와줌으로써,\n누구나 원하면 언제든지 여행할 수 있도록 하게 한 서비스다. 우수상을 수상한 라이트유(Light you)팀은\n시각장애인들을 위한 대체자료 구매 플랫폼(점차점자)을 소개했다.",
