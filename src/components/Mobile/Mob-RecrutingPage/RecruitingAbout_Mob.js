  ...
  const [question, setQuestion] = useState([
    {
      ...
      question: [{
        id: 1,
        quest: <>Q. &nbsp;경험과 실력도 부족한데 
                    <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;지원해도 될까요?</>,
        answer: <>A. PARD는 협업을 통한 성장과, <br />
                &nbsp; &nbsp; &nbsp;남을 주기 위해 배움을 기꺼이 즐기는 <br />
                &nbsp; &nbsp; &nbsp;것을 추구합니다.<br />
                &nbsp; &nbsp; &nbsp;따라서 경험과 실력보다는 기획, <br />
                &nbsp; &nbsp; &nbsp;디자인, 개발 각 파트에 대한 열정과<br />
                &nbsp; &nbsp; &nbsp;PARD 활동을 통해 이루고자 하시는 <br />
                &nbsp; &nbsp; &nbsp;목표를 더 중요시합니다.</>,
        select: false
      },
      {
        ...
        answer: <>A. 2기 기준 2023년도 포항시에 소재한 <br/>
                &nbsp; &nbsp; &nbsp;대학생, 대학원생이면 지원 가능합니다.      
        </>,
        select: false
      },
      {
        id: 3,
        quest:<> Q. &nbsp;한번에 여러파트로 중복 지원이 <br></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;가능할까요?</>,
        answer: <>
        A. 다양한 분야로 관심이 많으신<br/>
        &nbsp; &nbsp; &nbsp;예비 지원자님 정말 멋지십니다!<br/>
        &nbsp; &nbsp; &nbsp;하지만 아쉽게도 중복 지원은 <br/>
        &nbsp; &nbsp; &nbsp;어려울 것 같습니다. <br/>
      ...
      },
      {
        ...
        answer: <>A. OB의 신분에서만 참여가 가능한<br/>
        &nbsp; &nbsp; &nbsp;프로그램들이 있습니다.<br/>
        &nbsp; &nbsp; &nbsp;예를 들어 기업 연계 프로젝트나,<br/>
        &nbsp; &nbsp; &nbsp;인턴십 같은 경우는 <br/>
    ...
    },
    {
      ...
      },
      {
        ...
        answer: <>A. 2기 기준 iOS 앱 개발을 위한 <br/>&nbsp; &nbsp; &nbsp;Swift UIKit를 사용하고 있습니다.</>,
        select: false
      }
      ],
      selected: false,
    },
    {
      ...
      question: [
        ...
        {
          id: 2,
          quest: <>Q. 학기 중 매주 토요일 일정이 모두 <br/>&nbsp; &nbsp; &nbsp;비워져 있어야하나요?</>,
          answer: <>A. 7주차, 8주차, 14주차, 15주차 <br/>
          &nbsp; &nbsp; &nbsp;토요일에는 중간/기말고사를 준비할 수<br/>
          &nbsp; &nbsp; &nbsp;있도록 세미나를 진행하고 있지 않습니다!</>,
          select: false
        },
        {
          id: 3,
          quest: <>Q.  실제로 얼만큼의 리소스가<br/>&nbsp; &nbsp; &nbsp;투입되어야 할까요?</>,
          answer: <>A. 개인마다 다르겠지만,<br></br> 
          &nbsp; &nbsp; &nbsp;토요일 세미나를 제외하고 <br></br>
          &nbsp; &nbsp; &nbsp;주중 3-6학점 정도의<br></br>
          &nbsp; &nbsp; &nbsp;열정을 필요로 합니다!</>,
          select: false
    ...
    <Div>
      <PartDiv>
        <ThemeProvider theme={theme}>
          <Header7>파드에 대해 <br/>더 알고 싶어요</Header7>
            <QuestionWrap>
              {question.map((item) => (
