    ...
    <Div>
      <PartDiv>
        <ThemeProvider theme={theme}>
          <Header8>
            파드와 함께하는<br></br>여정을 소개해요.
          </Header8>

          <Subtitle2>
            2024년도 9월부터 1월까지 활동할<br></br>4기 멤버들을 모집합니다.
            <br></br>* 일부 일정 변동 가능
          </Subtitle2>
          ...
          <Container>
            ...
            <Box
              style={{
                border: "2px solid rgba(100, 197, 154, 0.4)",
                marginLeft: "70px",
              }}
            >
              <IconWrap>
            ...
            <Box
              style={{
                border: "2px solid rgba(100, 197, 154, 0.7)",
                marginLeft: "105px",
              }}
            >
              <IconWrap>
            ...
            <Box
              style={{
                border: "2px solid rgba(100, 197, 154, 1.0)",
                marginLeft: "139px",
              }}
            >
              <IconWrap>
