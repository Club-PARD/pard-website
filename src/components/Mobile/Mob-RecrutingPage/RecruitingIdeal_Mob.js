...
function RecruitingIdealMob() {
  const handleLinkClick = () => {
    window.location.href =
      "https://pardhgu.notion.site/ed2bc564ebf341eab08cfd8a24afe472";
  };
  return (
    <Div>
      <PartDiv>
        <ThemeProvider theme={theme}>
          ...
          <Container>
            ...
            <ContentDiv>
              ...
              <ContentText>
                우선순위를 정립하고 함께 추구하는
                <br /> 목표에 대한 <strong className="Green">열정</strong>을
                불태울 수 있으신 분
              </ContentText>
            </ContentDiv>
            <Horizon />
            <ContentDiv>
              ...
              <ContentText>
                빠르게 실패하되 작은 성공을 수집하며 파드
                <br /> 활동을 <strong className="Green">책임감</strong> 있게
                수행할 수 있으신 분
              </ContentText>
            </ContentDiv>
            <Horizon />
