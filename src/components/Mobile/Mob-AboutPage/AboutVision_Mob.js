      ...
      <PartDiv>
        <ThemeProvider theme={theme}>
          ...
          <Cover>
            ...
            <Subblack1>
              파드는 단순한 지식 습득과 프로젝트<br></br> 경험을 위한 동아리가
              아닙니다.<br></br>
              혼자보다는 함께 성장에 대한 끊임없는<br></br> 열망을 가지고{" "}
              <br></br>
              서비스 기획-디자인-개발 과정을 거쳐 <br></br>완성도 높은 서비스를
              만들어 냅니다.
            </Subblack1>
          </Cover>
          <Cover>
          ...
          <Cover>
            ...
            <Subblack2>
              단순히 일을 잘 분배하고 최선을 다한다는<br></br>것이 협업의
              전부라고 생각하지 않습니다.<br></br>
              모두가 공감하는 목표를 추구하고,<br></br>모든 의견과 피드백은
              선명한 솔직함에 <br></br>기반하며, 모자란 점을 투명하게 공유하고,
              <br></br>함께 보완하는 것이 진짜 협업이라고<br></br>믿고
              실천합니다.
            </Subblack2>
          </Cover>
          <Cover>
          ...
          <Cover>
            ...
            <Subblack3>
              동아리원 소속 대학의 알럼나이 분들과<br></br> 대학 재학생들을 잇는
              교두보 역할을<br></br>수행합니다.<br></br>
              동아리원들은 실무자분들로부터 현실적인<br></br> 조언을 구하고
              성장합니다.<br></br>
              Pay it forward에 공감하는 사람들이 <br></br>모여 교류하고
              소통함으로 IT 생태계를 <br></br>확장합니다.
            </Subblack3>
          </Cover>
        </ThemeProvider>
      </PartDiv>
