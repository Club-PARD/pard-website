    ...
    },
    {
      ...
      context: (
        <>
          ...
          주저하지 않습니다.
          <br />
          직군, 관심 분야와 관계없이 누구나 자유롭게 배우고
          <br /> 싶은 내용이 있다면 함께 학습할 사람을 모으고,
          <br />
          서로 정한 기간에 따라 전문 지식을 쌓아가고
          <br />
          이를 공유합니다.
        </>
      ),
    },
    {
      ...
      context: (
        <>
          ...
          협업 커뮤니케이션 및 방법론을 학습합니다.
          <br />
          조직 문화 및 커뮤니케이션 컨설팅사의 검수를 받은
          <br />
    ...
    },
    {
      ...
      context: (
        <>
          ...
          <br />
          극대화할 수 있는 방법을 모색하고, <br />
          혁신적인 아이디어를 어떻게 매력적으로
          <br />
          풀어낼 것인지 고민하고 실행합니다.
        </>
      ),
