  ...
  const [part, setPart] = useState([
    {
      ...
      context:
        <>
          사용자 중심 기반으로 서비스기획 일련의 과정을<br />
          배워 실제 서비스를 기획합니다. <br />
          아이디어 발상에서 그치는 것이 아닌 실제 기획과 <br />
          직결되는 IA, Flow-chart, 화면설계서 등의  <br />
          기획 산출물을 작성해보고 실제 프로덕트 개발에서 <br />어떻게 적용할 것인지 의견을 나눠요. <br />
          <br />
          단순한 서비스 기획에 필요한 하드스킬만을 배우는<br />것이 아니라 BM(비즈니스 모델), 데이터, 사용자<br />
          경험, 유저의 니즈에 기반해 근거 있는 기획을 할 수<br />있는 기반과 마인드를 가질 수 있습니다.
        </>,
    ...
    },
    {
      ...
      context:
        <>
          UX/UI 디자인 이론을 배우며, 사용자 중심 사고를 <br />기르고 개발 가능한 디자인을 구현합니다. <br />
          1인당 1개의 App/Web Product를 선택해 배운<br />
          내용들을 적용해보고 다각도에서 분석하면서<br />
          다양한 역량을 키우고 동시에 유의미한<br />
          포트폴리오를 완성해요.<br />
          <br />
          현업에 계시는 실무자 분들, 그리고 타 파트과의<br />
          협업을 통해 디자인 뿐 아니라 기획,<br />
          사용자 조사, 데이터 도출, 개발자와 협업 등 비즈니<br />스에 대한 이해와 전문성을 갖추어<br />
    ...
    },
    {
      ...
      context:
        <>
          ...
          실습/협업 합니다. <br />
          HTML/CSS/JS에 대해 기초를 빠르게 다지고,<br />React 프레임워크 기반으로 웹 서비스를<br />
          개발합니다. <br />
    ...
    },
    {
      ...
      context:
        <>
          ...
          서버를 관리하고, 전반적인 시스템 인프라를 구축 및<br />배포 및 운영 합니다. <br />
          자바의 객체지향, 서버, 관계형 데이터베이스를 <br />
          이해하고, Spring Boot의 기본기를 다지며 다양한 <br /> API를 구현하는 개발자로 성장합니다.<br />
          <br />
          클라이언트를 담당하는 앱/웹 파트와 협업하며 <br />
          의사소통 능력을 키우고, CI/CD를 구축할 수 있는 <br />개발자로 성장합니다.
        </>,
