  ...
  const [part, setPart] = useState([
    {
      ...
      <br/>사용자 중심 기반으로 서비스기획 일련의 과정을 
      <br/>배워 실제 서비스를 기획합니다.
      <br/>아이디어 발상에서 그치는 것이 아닌 실제 기획과
      <br/>직결되는 IA, Flow-chart, 화면 설계서 등의
      <br/>기획 산출물을 작성해보고 실제 프로덕트 개발에서
      <br/>어떻게 적용할 것인지 의견을 나눠요 
      <br/><br/>단순한 서비스 기획에 필요한 하드스킬만을 배우는
      <br/>것이 아니라 BM(비즈니스 모델), 데이터, 사용자
      <br/>경험, 유저의 니즈에 기반해 이유 있는 기획을 
      <br/>할 수 있는 기반과 마인드를 가질 수 있습니다.`    
       </>,
