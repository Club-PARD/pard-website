      ...
      <DIVVVV>
        <ThemeProvider theme={theme}>
          <VideoContainer isColor={backcolor}>
            ...
            {
              isSafari ?
                <VideoBackgroundImg src={require('../../../assets/img/BackgroundImg_Mob.png')} />
                :
                <VideoBackground autoPlay loop muted playsInline>
                  <source playsInline muted autoPlay src={require("../../../assets/Video/BackGroundVideo_Mob.mp4")} type="video/mp4" />
                </VideoBackground>
            }
